...
use super::{getdef::getdef_ulong, subordinateio::sub_uid_find_free_range};

///
pub fn find_new_sub_uids(range_start: &mut u32, range_count: &mut u32) -> i32 {
    ...
    let start = sub_uid_find_free_range(min, max, count);
    if start == -1 {
